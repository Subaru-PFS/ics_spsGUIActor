...
from spsGUIActor.control import ControlPanel, CommandsGB, ControlDialog
from spsGUIActor.modulerow import ModuleRow
from spsGUIActor.widgets import Coordinates, SwitchGB, DoubleSpinBoxGB, CustomedCmd, CmdButton, ValueMRow
