...
state2color = {"default": ('green', 'white'),
               ...
               "wiping": ('royalblue', 'white'),
               "integrating": ('paleturquoise', 'black'),
               "reading": ('mediumspringgreen', 'white'),
               "exposing": ('paleturquoise', 'black'),
               "idle": ('green', 'white'),
               "loading": ('orange', 'white'),
               "loaded": ('orange', 'white'),
